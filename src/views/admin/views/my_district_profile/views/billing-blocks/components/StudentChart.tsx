...
const StudentChart: React.FC = () => {
  ...
  useLayoutEffect(() => {
    // Create root element
    const root: am5.Root = am5.Root.new("student");
    ...
    const colors: { [key: string]: am5.Color } = {
      'Student Block': am5.color("#B85741"),
      'Not SPED Student': am5.color("#6FC8D6"),
      'Only Learning Disability': am5.color("#3E4C59"),
    ...
    const data: DataItem[] =
    apiValue?.billingBlockSummaryReports?.[0]?.billingBlockSummaries?.map((item) => ({
  ...
  return (
    <div>
      <div id="student" style={{ width: "100%", height: "400px" }}></div>
